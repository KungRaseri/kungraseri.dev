    ...
    const albums: Album[] = [
        {
            ...
            description: 'Released in 2018. Ascension is my first album and the start of my music production journey.',
            actions: [
                {
                    text: '',
                    href: ''
        ...
        },
        {
            ...
            description: 'Released in 2020. Emergent is my second album and was supposed to be released in 2019.',
            actions: [
                {
                    text: '',
                    href: ''
